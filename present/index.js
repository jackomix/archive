jQuery.ajaxPrefilter(function(options) {
    if (options.crossDomain && jQuery.support.cors) {
        options.url = 'https://yacdn.org/proxy/' + options.url;
    }
});
...
function getImage() {
  request.abort();
  request = $.ajax({
    url: 'https://reddit.com/r/' + subreddits[Math.floor(Math.random() * subreddits.length)] + '/random/.json?_=' + new Date().getTime(),
